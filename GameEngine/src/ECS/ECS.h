 ...
 namespace UE{
 	...
 	//using std::bitset<MAX_COMPONENTS> = std::bitset<MAX_COMPONENTS>;
 	...
 	public:
 		...
 		std::uint32_t CreateEntity()
 		{
 			...
 			std::uint32_t id = mAvailableEntities.front();
 	...
 	private:
 		...
 		std::queue<std::uint32_t> mAvailableEntities{};
 	...
 	public:
 		...
 		void RemoveData(std::uint32_t entity)
 		{
 			...
 			std::uint32_t entityOfLastElement = mIndexToEntityMap[indexOfLastElement];
 	...
 	private:
 		...
 		std::uint8_t mNextComponentType{};
 	...
 	{
 	public:
 		std::set<std::uint32_t> mEntities;
 	};
 	...
 	public:
 		...
 		void EntitySignatureChanged(std::uint32_t entity, std::bitset<MAX_COMPONENTS> entitySignature)
 		{
